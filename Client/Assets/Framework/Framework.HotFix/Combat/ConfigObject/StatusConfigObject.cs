...
namespace NFramework.ModuleSystem.Combat
{
    ...
    {
        [LabelText("状态ID")] public int Id;
        [LabelText("状态名称")] public string Name;
        public StatusType StatusType;

        [HideInInspector] public uint Duration;

        [LabelText("是否显示在状态栏上")] public bool SHowInStatusSlot;

        [LabelText("是否叠加")] public bool CanStack;

        [LabelText("最高叠加层数"), ShowIf("CanStack"), Range(0, 99)]
        public int MaxStack = 0;

        [LabelText("子状态效果")] public bool EnableChildStatus;

        [OnInspectorGUI("DrawSpace", append: true)]
        [HideReferenceObjectPicker]
        [LabelText("子状态效果列表"), ShowIf("EnableChildStatus"),
        ...
        [LabelText("状态特效")] [OnInspectorGUI("BeginBox", append: false)]
        public string ParticleEffectName;


        [LabelText("状态音效")] [OnInspectorGUI("EndBox", append: true)]
        public string AudioClipName;

        [TextArea, LabelText("状态描述")] public string StatusDescription;
