...
namespace NFramework.ModuleSystem.Module.Coroutine
{
    public interface ICoroutine
    {
    }

    internal class CoroutineM : FrameworkSystemModuleBase
    {
    ...
    public static class CoroutineExtension
    {
        ...
        {
            return NFROOT.Instance.GetSystem<CoroutineM>().StartCoroutine(owner, coroutine);
        }

        public static void StopAllCoroutines(this ICoroutine owner)
        {
            NFROOT.Instance.GetSystem<CoroutineM>().StopAllCoroutines(owner);
        }
    }
}