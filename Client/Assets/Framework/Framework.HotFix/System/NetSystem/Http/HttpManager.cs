...
namespace NFramework.ModuleSystem.Module.HttpModule
{
    /// <summary>
    /// HTTP 管理器
    /// 基于 UnityWebRequest 的 HTTP 短连接请求管理
    /// </summary>
    public class HttpM : FrameworkSystemModuleBase
    {
        #region 属性
        ...
        public override void Awake()
        {
            ...
            this.Log?.Print("HttpManager 初始化完成");
        }
        ...
        public override void Destroy()
        {
            ...
            this.Log?.Print("HttpManager 已关闭");
        }
