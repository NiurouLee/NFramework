namespace NFramework.ModuleSystem.Combat
{
    ...
    public class FloatNumeric : Entity, IAwakeSystem<NumericEntity, AttributeType>
    {
        ...
        {
            get { return m_NumericEntity.GetFloat(m_Type * 10 + 1); }
            set
            {
                m_NumericEntity.Set(m_Type * 10 + 1, value);
                var syncAttribute = new SyncModifyAttribute(Parent.Id, m_Type, 1, value);
                GetSystem<EventSystem>().Fire(ref syncAttribute);
            }
        }

        public float Add
        {
            get { return m_NumericEntity.GetFloat(m_Type * 10 + 2); }
            set
            {
        ...
        public float PctAdd
        {
            get { return m_NumericEntity.GetFloat(m_Type * 10 + 3); }
            set
            {
        ...
        {
            get { return m_NumericEntity.GetFloat(m_Type * 10 + 4); }
            set
            {
        ...
        {
            get { return m_NumericEntity.GetFloat(m_Type * 10 + 5); }
            set
            {
