...
namespace NFramework.ModuleSystem
{
    public static class MathHelper
    {
        ...
        public static List<Vector3> GetLineBezierList(Vector3 startPoint, Vector3 endPoint,
            int segmentNum = 10)
        {
            List<Vector3> path =  NFramework.Core.ListPool.Alloc<Vector3>();
            path.Add(startPoint);
        ...
        /// <param name="segmentNum"></param>采样点的数量
        /// <returns></returns>存储贝塞尔曲线点的数组
        public static List<Vector3> GetTwoBezierList(Vector3 startPoint, Vector3 controlPoint,
            Vector3 endPoint, int segmentNum = 10)
        {
            List<Vector3> path = ListPool.Alloc<Vector3>();
            path.Add(startPoint);
            for (int i = 1; i <= segmentNum; i++)
            {
                float t = i / (float)segmentNum;
        ...
        /// <param name="segmentNum"></param>采样点的数量
        /// <returns></returns>存储贝塞尔曲线点的数组
        public static List<Vector3> GetThreePowerBezierList(Vector3 startPoint, Vector3 controlPoint1,
